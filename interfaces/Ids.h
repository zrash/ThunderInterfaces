...
namespace Exchange {
    ...
    enum IDS : uint32_t {
        ...
        ID_BLUETOOTHAUDIO_SOURCE                     = ID_BLUETOOTHAUDIO + 3,
        ID_BLUETOOTHAUDIO_SOURCE_CALLBACK            = ID_BLUETOOTHAUDIO + 4,
        ID_BLUETOOTHAUDIO_SOURCE_CONTROL             = ID_BLUETOOTHAUDIO + 5,
